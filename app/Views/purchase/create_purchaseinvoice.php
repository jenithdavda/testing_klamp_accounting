    ...
    <div class="col-lg-12">
        <div class="card custom-card">
            <div class="card-header card-header-divider">
                <div class="card-body">
                    <form action="<?= url('Purchase/add_purchaseinvoice') ?>" class="ajax-form-submit-invoice" method="POST" id="Purchaseinvoiceform">
                        <div class="row">
                            ...
                            <div class="col-lg-6 form-group">
                                ...
                                <input class="form-control" readonly type="text" name="invoice_no" value="<?= isset($purchaseinvoice['invoice_no']) ? @$purchaseinvoice['invoice_no'] : $current_id ?>">
                            </div>

                            <div class="col-lg-6 form-group">
                                <label class="form-label">Invoice Date: </label>
                                <input class="form-control fc-datepicker" placeholder="YYYY-MM-DD" type="text" name="invoice_date" value="<?= @$purchaseinvoice['invoice_date'] ? $purchaseinvoice['invoice_date'] : date('Y-m-d') ?>">
                            </div>
                            <div class="col-lg-6 form-group">
                            ...
                            <div class="col-lg-5 form-group">
                                <div class="row">
                                    <div class="row col-lg-12 form-group">
                                        ...
                                        <input type="hidden" name="tds_per" id="tds_per" value="<?= @$purchaseinvoice['tds_per']; ?>">
                                        <input type="hidden" name="tds_limit" id="tds_limit" value="<?= @$purchaseinvoice['tds_limit']; ?>">
                                        <input type="hidden" name="acc_state" id="acc_state" value="<?= @$purchaseinvoice['acc_state']; ?>">
                                        <input type="hidden" name="gl_group" value="<?= @$purchaseinvoice['gl_group']; ?>">

                                    </div>
                                    <div class="row col-md-12 form-group">
                                        <label class="form-label col-md-4">GST No.: <span class="tx-danger">*</span></label>
                                        <input readonly class="form-control col-md-8 gst_no" type="text" name="gst_no" id="gst_no" value="<?= @$purchaseinvoice['gst_no']; ?>">
                                    </div>
                                    <div class="row col-md-12 form-group">
                                        <label class="form-label col-md-4">Suppl. invoice : <span class="tx-danger"></span></label>
                                        <input class="form-control col-md-8 supply_inv" name="supply_inv" value="<?= @$purchaseinvoice['supply_inv']; ?>" type="text" formnovalidate>
                                    </div>

                                    <div class="row col-md-12 form-group">
                                        <label class="form-label col-md-4">Due Days: </label>
                                        <input class="form-control col-md-8" name="due_days" id="due_days" value="<?= @$purchaseinvoice['due_days'] ?>" placeholder="Enter Due Days" onkeypress="return isNumberKey(event)" onkeyup="getduedate(this.value)" type="text" formnovalidate>
                                    </div>

                                    <div class="row col-md-12 form-group">
                                        <label class="form-label col-md-4">Due Date: </label>
                                        <input class="form-control fc-datepicker col-md-8" placeholder="YYYY-MM-DD" type="text" id="due_date" onchange="getduedays(this.value)" name="due_date" value="<?= @$purchaseinvoice['due_date'] ?>">
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-5 form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="hidden" value="<?= @$purchaseinvoice['fix_brokrage'] ?>" id="fix_brokrage" name="brokrage">
                                        </div>
                                    </div>
                                    <div class="col-md-2 form-group">
                                    ...
                                    <div class="col-md-3 form-group">
                                        <label class="rdiobox"><input checked name="brokerage_type" <?= @$purchaseinvoice['brokrage_type'] == "fix" ? 'checked' : ''  ?> value="fix" type="radio" onchange="calculate()">
                                            <span>Fix</span></label>

                                        <label class="rdiobox"><input name="brokerage_type" <?= @$purchaseinvoice['brokrage_type'] == "item_wise" ? 'checked' : ''  ?> value="item_wise" type="radio" onchange="calculate()"> <span>Item
                                                Wise</span></label>
                                    </div>
                                    <div class="col-md-2 form-group">
                                    ...
                                    <div class="col-lg-10 form-group">
                                        <div class="input-group">
                                            <input class="form-control other" name="other" value="<?= @$purchaseinvoice['other'] ?>" placeholder="Enter Other Detail" type="text">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-8 form-group">
                                        <input class="form-control party_bill" name="party_bill" placeholder="Enter Supplier Challan no." onkeypress="return isDesimalNumberKey(event)" value="<?= @$purchaseinvoice['sup_chl_no'] ?>" type="text">
                                    </div>
                                    ...
                                    <div class="col-md-4 form-group">
                                        <input class="form-control lr" name="lr_no" onkeypress="return isDesimalNumberKey(event)" value="<?= @$purchaseinvoice['lr_no'] ?>" placeholder="" type="text">
                                    </div>
                                    <div class="col-md-2 form-group">
                                    ...
                                    <div class="col-md-4 form-group">
                                        <input class="form-control fc-datepicker lr_data" placeholder="YYYY-MM-DD" type="text" name="lr_date" value="<?= @$purchaseinvoice['lr_date'] ?>">
                                    </div>
                                    ...
                                    <div class="col-md-4 form-group">
                                        <div class="input-group">
                                            ...
                                            <select class="select2 trans_mode" id="transport_mode" name="transport_mode">
                                                ...
                                                <option <?= (@$purchaseinvoice['transport_mode'] == "Rail") ? 'selected' : '' ?> value="Rail">Rail</option>
                                                <option <?= (@$purchaseinvoice['transport_mode'] == "Road") ? 'selected' : ''  ?> value="Road">Road</option>
                                                <option <?= (@$purchaseinvoice['transport_mode'] == "Air") ? 'selected' : ''  ?> value="Air">Air</option>
                                                <option <?= (@$purchaseinvoice['transport_mode'] == "Ship") ? 'selected' : ''  ?> value="Air">Ship</option>
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <table class="table table-bordered mg-b-0">
                                            <thead>
                                                ...
                                                <tr>
                                                    ...
                                                    <th class="wd-300">
                                                        <div class="input-group">
                                                            <input class="form-control discount" onchange="calculate()" onkeypress="return isDesimalNumberKey(event)" name="discount" type="text" value="<?= @$purchaseinvoice['discount']; ?>">
                                                            <div class="input-group-prepend">
                                                                <select class="select2 disc_type" name="disc_type" onchange="calculate()">
                                                                    <option <?= (@$purchaseinvoice['disc_type'] == 'Fixed' ? 'selected' : '') ?> value="Fixed">Fixed Amount</option>
                                                                    <option <?= (@$purchaseinvoice['disc_type'] == '%' ? 'selected' : '') ?> value="%">Per(%) Amount</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                    </th>
                                                ...
                                                <tr>
                                                    ...
                                                    <th class="wd-300">
                                                        <div class="input-group">
                                                            <input class="form-control amty" onchange="calculate()" onkeypress="return isDesimalNumberKey(event)" name="amty" type="text" value="<?= @$purchaseinvoice['amty']; ?>">
                                                            <div class="input-group-prepend">
                                                                <select class="select2 amty_type" name="amty_type" onchange="calculate()">
                                                                    <option <?= (@$purchaseinvoice['amty_type'] == 'Fixed' ? 'selected' : '') ?> value="Fixed">Fixed Amount</option>
                                                                    <option <?= (@$purchaseinvoice['amty_type'] == '%' ? 'selected' : '') ?> value="%">Per(%) Amount</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                    </th>
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="2"><input name="taxable" value="<?= @$purchaseinvoice['taxable'] ?>" class="form-control input-sm" type="text" readonly>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr id="igst" style="display:<?php if (!empty($taxes)) {
                                                    ...
                                                    <th class="wd-300">
                                                        <div class="input-group-sm">
                                                            <input class="form-control" readonly onchange="calculate()" onkeypress="return isDesimalNumberKey(event)" name="tot_igst" type="text" value="<?= @$purchaseinvoice['tot_igst']; ?>">
                                                        </div>
                                                    </th>
                                                ...
                                                <tr id="sgst" style="display:<?php if (!empty($taxes)) {
                                                    ...
                                                    <th class="wd-300">
                                                        <div class="input-group-sm">
                                                            <input class="form-control" readonly onchange="calculate()" onkeypress="return isDesimalNumberKey(event)" name="tot_sgst" type="text" value="<?= @$purchaseinvoice['tot_sgst']; ?>">
                                                ...
                                                <tr id="cgst" style="display:<?php if (!empty($taxes)) {
                                                    ...
                                                    <th class="wd-300">
                                                        <div class="input-group-sm">
                                                            <input class="form-control" readonly onchange="calculate()" onkeypress="return isDesimalNumberKey(event)" name="tot_cgst" type="text" value="<?= @$purchaseinvoice['tot_cgst']; ?>">
                                                ...
                                                <tr id="tds" style="display:<?php if (!empty($taxes)) {
                                                    ...
                                                    <th class="wd-300">
                                                        <div class="input-group-sm">
                                                            <input class="form-control tds_amt" readonly onchange="calculate()" onkeypress="return isDesimalNumberKey(event)" name="tds_amt" type="text" value="<?= @$purchaseinvoice['tds_amt']; ?>">
                                                ...
                                                <tr id="cess" style="display:<?php if (!empty($taxes)) {
                                                    ...
                                                    <th class="wd-300">
                                                        <div class="input-group">
                                                            <input class="form-control cess" onchange="calculate()" onkeypress="return isDesimalNumberKey(event)" name="cess" type="text" value="<?= @$purchaseinvoice['cess']; ?>">
                                                            <div class="input-group-prepend">
                                                                <select class="select2 cess_mode" name="cess_type" onchange="calculate()">
                                                                    <option <?= (@$purchaseinvoice['cess_type'] == 'Fixed' ? 'selected' : '') ?> value="Fixed">Fixed Amount</option>
                                                                    <option <?= (@$purchaseinvoice['cess_type'] == '%' ? 'selected' : '') ?> value="%">Per(%) Amount</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                    </th>
                                                ...
                                                <tr>
                                                    <th>
                                                        <div class="input-group-sm">
                                                            <select class="select2" id="round" name="round">
                                                                <?php if (@$purchaseinvoice['round']) { ?>
                                                                    <option value="<?= @$purchaseinvoice['round'] ?>">
                                                                        <?= @$purchaseinvoice['round_name'] ?>
                                                                    </option>
                                                                <?php } else { ?>
                                                    ...
                                                    <th><input class="form-control input-sm" onchange="calculate()" value="<?= @$purchaseinvoice['round_diff'] ?>" name="round_diff" type="text"></th>
                                                    <td class="wd-90 cr_dr_round"></td>
                                                </tr>

                                                <tr>
                                                    <td>Net Amount</td>
                                                    <td colspan="2"><input class="form-control input-sm net_amt" name="net_amount" type="text" value="<?= @$purchaseinvoice['net_amount']; ?>" readonly>
                                                    </td>
                                                </tr>
                                            </thead>
                                        </table>
            ...
            for (i = 0; i < item.length; i++) {
                ...
                if (item[i]['is_expence'] == 0) {
                    ...
                    tds += '<td><a class="tx-danger btnDelete" data-id="' + item[i].id +
                        '" title="0"><i class="fa fa-times tx-danger"></i></a></td>';
                    tds += '<td>' + item[i].name + '(' + item[i].hsn + ')' + inp + expence + taxability + '</td>';
